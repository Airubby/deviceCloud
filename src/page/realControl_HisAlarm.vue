    ...
    data() {
       return {
           ...
           table_columns:[
              ...
              { prop: 'topLevelName', label: '事件等级',minWidth:80,sortable:true},              
              { prop: 'state', label: '状态',minWidth:60,slotName:'preview-state',sortable:true},              
              { prop: 'occurTime', label: '触发时间',minWidth:90,slotName:'preview-occurTime',sortable:true},
              { prop: 'removeTime', label: '解除时间',minWidth:90,slotName:'preview-removeTime',sortable:true},
